...
async function main() {
  ...
  const prop1 = await prisma.property.create({
    data: {
      ...
      description:
        "Stunning 2-bedroom apartment in the heart of downtown. Features floor-to-ceiling windows, modern kitchen with stainless steel appliances, hardwood floors, and breathtaking city views. Building amenities include 24/7 concierge, fitness center, rooftop pool, and secure parking.",
      ...
      petPolicy: {
        allowed: true,
        deposit: 500,
        restrictions: "Max 2 pets, under 50lbs",
      },
  ...
  const prop2 = await prisma.property.create({
    data: {
      ...
      description:
        "Charming studio apartment perfect for young professionals. Features an open floor plan, modern kitchen, large windows with natural light, and updated bathroom. Walking distance to cafes, restaurants, and public transit.",
  ...
  const prop3 = await prisma.property.create({
    data: {
      ...
      description:
        "Beautiful 4-bedroom house perfect for families. Features include a large backyard, modern kitchen, spacious living areas, master suite with walk-in closet, and 2-car garage. Located in a quiet, family-friendly neighborhood with excellent schools nearby.",
  ...
  await prisma.inspection.create({
    data: {
      ...
      duration: 30,
      tenantNotes:
        "Very interested in this property. Would like to see the gym facilities.",
    },
  });
  ...
  await prisma.application.create({
    data: {
      ...
      vehicles: [
        { make: "Honda", model: "Civic", year: 2020, licensePlate: "ABC1234" },
      ],
  ...
  await prisma.application.create({
    data: {
      ...
      pets: [],
      vehicles: [
        { make: "Toyota", model: "Camry", year: 2021, licensePlate: "XYZ5678" },
      ],
