...
export class ApplicationController {
  ...
  update = asyncHandler(async (req: Request, res: Response) => {
    const userId = req.user!.userId;
    const application = await applicationService.update(req.params.id, userId, req.body);
  ...
  approve = asyncHandler(async (req: Request, res: Response) => {
    ...
    const application = await applicationService.approve(req.params.id, landlordId, conditions);
  ...
  reject = asyncHandler(async (req: Request, res: Response) => {
    ...
    const application = await applicationService.reject(req.params.id, landlordId, rejectionReason);
