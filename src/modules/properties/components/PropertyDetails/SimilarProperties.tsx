...
export const SimilarProperties: React.FC<SimilarPropertiesProps> = ({ 
  ...
  const fetchSimilarProperties = useCallback(async () => {
    try {
      ...
      const similar = await propertyService.getSimilarProperties(property.id, maxItems + 1);
  ...
  const handleViewAll = () => {
    navigate(`/properties?propertyType=${encodeURIComponent(property.propertyType)}`);
  };
    ...
    <div className="mt-12">
      ...
      <div className="mt-10 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Looking for more options?</h3>
          <p className="text-gray-600 mb-4">
            We have hundreds of properties that might interest you. Let us help you find your dream home.
          </p>
