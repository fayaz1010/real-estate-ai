...
export const PropertyContact: React.FC<PropertyContactProps> = ({ property }) => {
  ...
  const agent = {
    ...
    avatar: property.agentInfo?.avatar || 'https://randomuser.me/api/portraits/men/42.jpg',
    ...
    role: property.agentInfo?.brokerageName ? 'Broker' : 'Licensed Real Estate Agent',
  ...
  const handleScheduleTour = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      console.log('Tour scheduled:', { ...formData, tourDate: selectedDate, tourTime: selectedTime });
      setIsSubmitting(false);
      setIsSubmitted(true);
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6 pb-6 border-b">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600">{agent.licenseNumber ? 'Licensed Agent' : agent.role}</p>
          <p className="text-sm text-gray-500">{agent.brokerageName || agent.company}</p>
          ...
          <div className="mt-2 flex items-center gap-2">
            <div className="flex items-center">
              ...
              <span className="ml-1 text-sm text-gray-600">{agent.rating} ({agent.reviewsCount} reviews)</span>
            </div>
          </div>
