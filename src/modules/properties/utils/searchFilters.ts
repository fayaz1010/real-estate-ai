...
export const searchFilterUtils = {
  ...
  applyFilters: (
    ...
    return properties.filter((property) => {
      ...
      if (
        filters.bedroomsMin &&
        property.details.bedrooms < filters.bedroomsMin
      ) {
        return false;
      }
      if (
        filters.bedroomsMax &&
        property.details.bedrooms > filters.bedroomsMax
      ) {
        return false;
      }
      ...
      if (
        ...
        property.details.bathrooms < filters.bathroomsMin
      ) {
        return false;
      }
      if (
        filters.bathroomsMax &&
        property.details.bathrooms > filters.bathroomsMax
      ) {
        return false;
      }
      ...
      if (
        ...
        property.details.furnished !== filters.furnished
      ) {
        return false;
      }
      ...
      if (
        ...
        property.details.parking.spaces < filters.parkingSpaces
      ) {
        return false;
      }
  ...
  getActiveFilterCount: (filters: SearchFilters): number => {
    ...
    if (filters.bathrooms || filters.bathroomsMin || filters.bathroomsMax)
      count++;
  ...
  queryStringToFilters: (queryString: string): SearchFilters => {
    ...
    if (params.has("priceMax"))
      filters.priceMax = Number(params.get("priceMax"));
    if (params.has("bedrooms"))
      filters.bedrooms = Number(params.get("bedrooms"));
    if (params.has("bathrooms"))
      filters.bathrooms = Number(params.get("bathrooms"));
