      ...
      <div className="flex items-center justify-center py-20" role="status">
        <div className="text-center">
          <div
            ...
            aria-hidden="true"
          />
          <p className="text-sm text-gray-500 font-open-sans">Loading payments...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center py-20" role="alert">
        <div className="bg-white rounded-2xl shadow-sm p-8 max-w-md text-center">
          ...
          <h2 className="font-montserrat text-xl font-bold text-tenant-primary mb-2">Error</h2>
    ...
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden transition-shadow hover:shadow-md">
            <div className="p-6 pb-4">
              <div className="flex items-center gap-2">
                <Calendar className="w-5 h-5 text-tenant-primary" aria-hidden="true" />
                <h2
                  id="upcoming-heading"
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm font-open-sans" aria-label="Upcoming payments">
                <thead>
      ...
      <section aria-labelledby="history-heading">
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden transition-shadow hover:shadow-md">
          ...
          {payments.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="w-full text-sm font-open-sans" aria-label="Payment history">
                <thead>
                  <tr className="bg-gray-50 text-left text-xs text-gray-500 uppercase tracking-wider">
