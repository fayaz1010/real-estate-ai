  ...
  return (
    <div className="w-full max-w-md mx-auto px-4">
      ...
      <div className="text-center mb-8 animate-fade-in">
        ...
        <p className="text-gray-500 text-lg">Your Premium Real Estate Platform</p>
      </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${
                  validationErrors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-100' : 'border-gray-200'
                }`}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-12 py-3.5 border-2 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${
                  validationErrors.password ? 'border-red-300 focus:border-red-500 focus:ring-red-100' : 'border-gray-200'
                }`}
                placeholder="••••••••"
