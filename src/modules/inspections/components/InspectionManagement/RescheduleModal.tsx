...
export const RescheduleModal: React.FC<RescheduleModalProps> = ({
  ...
  const { canReschedule, reason: cannotRescheduleReason } =
    canRescheduleInspection(inspection.scheduledDate);
      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
            The landlord will need to confirm the new date and time. You&apos;ll
