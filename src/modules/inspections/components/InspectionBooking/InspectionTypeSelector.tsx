...
export const InspectionTypeSelector: React.FC<InspectionTypeSelectorProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Choose Inspection Type</h2>
        <p className="text-gray-600">Select how you'd like to view the property</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="text-sm text-blue-900">
          ...
          <p>In-person tours are recommended for the best experience. Virtual tours are perfect if you're relocating from another city.</p>
        </div>
      </div>
    </div>
  );
