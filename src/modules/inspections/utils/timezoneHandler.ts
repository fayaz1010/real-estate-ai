...
export function getUserTimezone(): string {
   ...
   */
  export function fromISOStringWithTimezone(isoString: string, timezone: string): Date {
  ...
  export function getBusinessHours(
    ...
    const userStart = convertTimezone(propertyStart, propertyTimezone, userTimezone);
