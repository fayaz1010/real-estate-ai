...
export const fetchPropertyApplications = createAsyncThunk(
  ...
  async ({
    ...
    const applications = await applicationService.getPropertyApplications(
      propertyId,
      filters,
    );
    return applications;
...
export const applyToMultipleProperties = createAsyncThunk(
  ...
  async ({
    ...
    const applications = await applicationService.applyToMultipleProperties(
      propertyIds,
      data,
    );
    return applications;
...
const applicationSlice = createSlice({
  ...
  reducers: {
    ...
    updateFormData: (
      state,
      action: PayloadAction<Partial<ApplicationFormData>>,
    ) => {
