...
import { VerificationStatus, CreditCheckResult, BackgroundCheckResult } from '../types/application.types';
import { 
  verificationService,
...
import { backgroundCheckService, BackgroundCheckRequest } from '../services/backgroundCheckService';
...
export const verifyIdentity = createAsyncThunk(
  ...
  async ({ applicationId, data }: { applicationId: string; data: IdentityVerificationRequest }) => {
    const result = await verificationService.verifyIdentity(applicationId, data);
    return result;
  }
);
...
export const verifyIncome = createAsyncThunk(
  'verification/income',
  async ({ applicationId, data }: { applicationId: string; data: IncomeVerificationRequest }) => {
...
export const verifyEmployment = createAsyncThunk(
  ...
  async ({ applicationId, data }: { applicationId: string; data: EmploymentVerificationRequest }) => {
    const result = await verificationService.verifyEmployment(applicationId, data);
    return result;
  }
);
...
export const orderCreditCheck = createAsyncThunk(
  ...
  async ({ applicationId, packageId, data }: { 
    applicationId: string; 
    packageId: string;
    data: CreditCheckRequest;
  }) => {
    const result = await creditCheckService.orderCreditCheck(applicationId, packageId, data);
    return result;
  }
);
...
export const orderBackgroundCheck = createAsyncThunk(
  ...
  async ({ applicationId, packageId, data }: {
    ...
    const result = await backgroundCheckService.orderBackgroundCheck(applicationId, packageId, data);
    return result;
  }
);
...
export const getBackgroundCheckStatus = createAsyncThunk(
  ...
  async (applicationId: string) => {
    const result = await backgroundCheckService.getBackgroundCheckStatus(applicationId);
    return result;
  }
);
...
export const exchangePlaidToken = createAsyncThunk(
  ...
  async ({ applicationId, publicToken }: { applicationId: string; publicToken: string }) => {
    const result = await verificationService.exchangePlaidToken(applicationId, publicToken);
    return result;
  }
);
...
export const sendPhoneVerification = createAsyncThunk(
  ...
  async ({ applicationId, phoneNumber }: { applicationId: string; phoneNumber: string }) => {
    const result = await verificationService.sendPhoneVerificationCode(applicationId, phoneNumber);
    return result;
  }
);
...
export const confirmPhoneVerification = createAsyncThunk(
  ...
  async ({ applicationId, code }: { applicationId: string; code: string }) => {
    const result = await verificationService.confirmPhoneVerificationCode(applicationId, code);
    return result;
  }
);
