...
const RentalHistoryStep: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Rental History</h2>
        <p className="text-gray-600">
          Provide details about your previous rental properties. At least one entry is required.
        </p>
      </div>

      {/* Rental History List */}
      <div className="space-y-4">
        {rentalHistory.map((rental: Partial<RentalHistoryEntry>, index: number) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="border-t pt-4">
                <h4 className="font-medium text-gray-900 mb-3">Landlord/Property Manager</h4>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Landlord Name *
                    ...
                    <input
                      ...
                      onChange={(e) => handleUpdate(index, 'landlordName', e.target.value)}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => handleUpdate(index, 'landlordPhone', e.target.value)}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => handleUpdate(index, 'landlordEmail', e.target.value)}
                          className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => handleUpdate(index, 'monthlyRent', parseFloat(e.target.value) || 0)}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleUpdate(index, 'reasonForLeaving', e.target.value)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  rows={3}
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleUpdate(index, 'canContact', e.target.checked)}
      ...
      {rentalHistory.length === 0 && (
        <div className="text-center text-gray-500 py-8">
          No rental history added yet. If this is your first rental, you can skip this or add details about your current living situation.
        </div>
      )}

      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <p className="text-sm text-yellow-800">
          <strong>First-time renter?</strong> If you don't have rental history, that's okay! You may need to provide additional verification or a co-signer. Focus on building a strong application with your employment and income information.
        </p>
      </div>
    </div>
  );
