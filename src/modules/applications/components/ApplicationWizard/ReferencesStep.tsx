    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Provide at least 2 references who can vouch for your character and
          reliability.
        </p>
      </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={ref.phone || ""}
                      onChange={(e) =>
                        handleUpdate(index, "phone", e.target.value)
                      }
      ...
      {references.length < 2 && references.length > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-800">
            <strong>Note:</strong> You need at least 2 references. Please add{" "}
            {2 - references.length} more.
          </p>
        </div>
      )}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>
            • Choose people who know you well and can speak to your character
          </li>
          <li>
            • Employers, supervisors, and previous landlords make excellent
            references
          </li>
