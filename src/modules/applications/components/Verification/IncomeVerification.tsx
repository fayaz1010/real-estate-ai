...
const IncomeVerification: React.FC<IncomeVerificationProps> = ({
  applicationId,
}) => {
  const { incomeStatus, startIncomeVerification, initializePlaid, loading } =
                ...
                {uploadedDocs.map((doc, index) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        setUploadedDocs(
                          uploadedDocs.filter((_, i) => i !== index),
                        )
                      }
        ...
        <div className="space-y-6">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              Powered by Plaid • Bank-level security • Your credentials are
              never stored
            </p>
          </div>
        </div>
