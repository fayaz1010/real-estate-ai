...
import { 
  ...
  export const applicationService = {
     ...
     */
    getMyApplications: async (filters?: ApplicationFilters): Promise<Application[]> => {
     ...
     */
    getApplicationSummary: async (propertyId?: string): Promise<ApplicationSummary> => {
     ...
     */
    getApplicationScore: async (applicationId: string): Promise<{
      score: number;
      breakdown: any;
      rating: string;
    }> => {
    ...
    updateCoApplicant: async (
      ...
      return apiCall(`/applications/${applicationId}/co-applicants/${coApplicantId}`, {
        method: 'PATCH',
        body: JSON.stringify(data),
      });
    },
    ...
    parseDocument: async (
      ...
      return apiCall(`/applications/${applicationId}/documents/${documentId}/parse`, {
        method: 'POST',
      });
    },
     ...
     */
    compareApplications: async (applicationIds: string[]): Promise<{
