...
export const defaultWorkflows: WorkflowTemplate[] = [
    ...
    steps: [
      ...
      },
      {
        ...
        configuration: {
          ...
          description: 'Prepare welcome package and key handover for {{tenant.firstName}} {{tenant.lastName}} at {{property.address}}',
        },
      },
      {
        id: 'welcome-3',
        ...
        configuration: {
          ...
          message: 'New tenant {{tenant.firstName}} {{tenant.lastName}} has been added to {{property.address}}. Lease starts on {{lease.startDate}}.',
        },
      },
    ],
  },
  {
    ...
    description: 'Reminds tenants and landlords about upcoming lease expirations 30 days before the end date.',
    ...
    steps: [
      ...
      },
      {
        ...
        configuration: {
          recipientType: 'landlord',
          recipientId: '{{landlord.id}}',
          message: 'Lease for {{tenant.firstName}} {{tenant.lastName}} at {{property.address}} expires on {{lease.endDate}}. Follow up on renewal.',
        },
      },
      {
        id: 'lease-exp-3',
        ...
        configuration: {
          ...
          description: 'Follow up on lease renewal for {{property.address}} - Tenant: {{tenant.firstName}} {{tenant.lastName}}',
        },
      },
    ],
  },
  {
    ...
    description: 'Creates a task and notifies the landlord when a new maintenance request is submitted.',
    ...
    steps: [
      {
        ...
        configuration: {
          assignee: '{{landlord.id}}',
          dueDate: '{{dueDate}}',
          description: 'Maintenance request from {{tenant.firstName}}: {{maintenanceRequest.description}} at {{property.address}}',
        },
      },
      {
        id: 'maint-2',
        ...
        configuration: {
          recipientType: 'landlord',
          recipientId: '{{landlord.id}}',
          message: 'New maintenance request at {{property.address}}: {{maintenanceRequest.description}}. Priority: {{maintenanceRequest.priority}}',
        },
      },
      {
        id: 'maint-3',
  ...
  },
  {
    ...
    description: 'Sends a thank-you email and notification after a rent payment is received.',
    ...
    steps: [
      ...
      },
      {
        ...
        configuration: {
          recipientType: 'landlord',
          recipientId: '{{landlord.id}}',
          message: 'Payment of {{payment.amount}} received from {{tenant.firstName}} {{tenant.lastName}} for {{property.address}}.',
        },
      },
    ],
  },
  {
    ...
    description: 'Sends push notifications for time-sensitive late payment alerts.',
    ...
    steps: [
      {
        ...
        configuration: {
          ...
          message: 'Reminder: Your rent payment of {{payment.amount}} for {{property.address}} is overdue. Please make your payment as soon as possible to avoid late fees.',
        },
      },
      {
        id: 'late-pay-2',
        ...
        configuration: {
          recipientType: 'landlord',
          recipientId: '{{landlord.id}}',
          message: 'Late payment alert: {{tenant.firstName}} {{tenant.lastName}} has an overdue payment of {{payment.amount}} for {{property.address}}.',
        },
      },
    ],
  },
  {
    ...
    description: 'Optimizes property listing SEO based on high-intent commercial keywords and market data.',
    ...
    steps: [
      ...
      },
      {
        ...
        configuration: {
          recipientType: 'landlord',
          recipientId: '{{landlord.id}}',
          message: 'SEO optimization completed for {{property.address}}. Keywords updated to improve search visibility.',
        },
      },
    ],
  },
  {
    ...
    description: 'Prompts users to upgrade their subscription when they hit plan limits.',
    triggerType: WorkflowTriggerType.MANUAL,
  ...
  },
  {
    ...
    description: 'Sends a daily digest with vacancy alerts, maintenance predictions, and rent optimization opportunities.',
    triggerType: WorkflowTriggerType.SCHEDULED,
    category: 'Engagement',
    steps: [
      {
