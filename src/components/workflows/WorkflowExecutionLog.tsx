...
export const WorkflowExecutionLog: React.FC<WorkflowExecutionLogProps> = ({ logs }) => {
  if (logs.length === 0) {
    return (
        ...
        <div key={log.id} className="flex items-center gap-4 py-3 px-1">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-[#091a2b]" style={{ fontFamily: 'Open Sans, sans-serif' }}>
          ...
          <span className="text-xs text-gray-400 flex-shrink-0" style={{ fontFamily: 'Open Sans, sans-serif' }}>
