...
const tiers: PricingTier[] = [
  {
    ...
    monthlyPrice: "$0",
    monthlyUnit: "/mo",
    monthlyMin: "Up to 5 units",
    annualPrice: "$0",
    annualUnit: "/mo",
    annualMin: "Up to 5 units",
    features: [
      "Up to 5 units",
  ...
  },
  {
    ...
    monthlyPrice: "$125",
    monthlyUnit: "/mo + $2/unit",
    monthlyMin: "Up to 100 units",
    annualPrice: "$100",
    annualUnit: "/mo + $2/unit",
  ...
  },
  {
    ...
    monthlyPrice: "$400",
    monthlyUnit: "/mo + $1.50/unit",
    monthlyMin: "Up to 300 units",
    annualPrice: "$320",
    annualUnit: "/mo + $1.50/unit",
    annualMin: "Up to 300 units, billed annually",
    features: [
      "Up to 300 units",
  ...
  },
  {
    ...
    monthlyPrice: "$1,264+",
    monthlyUnit: "/mo",
    monthlyMin: "Unlimited units",
    annualPrice: "Custom",
    annualUnit: "",
    annualMin: "Unlimited units",
    features: [
      "Unlimited units",
      "White-label options",
      "Dedicated CSM",
