  ...
  const renderSkeletons = () =>
    viewMode === "table"
      ...
      : Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="bg-white rounded-xl border border-primary/10 p-5"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text_primary/60 font-body">
                Manage listings, statuses, and details
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
                  ...
                  <tr className="border-b border-primary/10 bg-primary/[0.02]">
                    ...
                    <th className="text-left px-6 py-3 text-xs font-semibold text-text_primary/60 uppercase tracking-wider">
                      <button
                        ...
                        className="flex items-center gap-1 hover:text-text_primary"
                      >
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div>
                            ...
                            <p className="text-xs text-text_primary/50">
                              {p.propertyType} &middot; {p.bedrooms}bd /{" "}
                              {p.bathrooms}ba
                            </p>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${getStatusClasses(p.status)}`}
                          >
                            {p.status}
                          </span>
                        </td>
                ...
                properties.map((p) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="font-semibold text-text_primary text-sm">
                          {p.title}
                        </h3>
                      ...
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold ${getStatusClasses(p.status)}`}
                      >
                        {p.status}
                      </span>
                    </div>
                    ...
                    <p className="text-lg font-bold text-text_primary mb-4">
                      {formatCurrency(p.price)}
                    </p>
                    <div className="flex items-center gap-2">
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="border-t border-primary/10 pt-4">
                <h3 className="text-sm font-semibold text-text_primary mb-3">
                  Address
                </h3>
              ...
              <div className="flex items-center gap-6 pt-2">
                ...
                <label className="flex items-center gap-2 text-sm text-text_primary cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((f) => ({ ...f, verified: e.target.checked }))
                    }
                    className="rounded border-primary/30"
                  />
                  Verified
