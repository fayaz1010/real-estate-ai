      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="card-elevated p-6">
            ...
            <p className="text-sm text-realestate-secondary font-inter">
              Total Users
            </p>
          ...
          <div className="flex items-end gap-3 h-48">
            {MONTHLY_REVENUE_DATA.map((data) => (
              ...
              >
                ...
                />
                <span className="text-xs font-medium text-realestate-primary">
                  {data.month}
                </span>
              </div>
            ))}
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="pb-3 text-sm font-semibold text-realestate-secondary font-inter">
                  Property
                </th>
                <th className="pb-3 text-sm font-semibold text-realestate-secondary font-inter hidden md:table-cell">
                  Type
                </th>
                <th className="pb-3 text-sm font-semibold text-realestate-secondary font-inter">
                  Price
                </th>
                <th className="pb-3 text-sm font-semibold text-realestate-secondary font-inter hidden sm:table-cell">
                  Owner
                </th>
                <th className="pb-3 text-sm font-semibold text-realestate-secondary font-inter">
                  Status
            ...
            <tbody className="divide-y divide-gray-100">
              {MOCK_PROPERTIES.slice(0, 3).map((property) => (
                ...
                >
                  <td className="py-3">
                    <p className="font-medium text-realestate-primary text-sm">
                      {property.title}
                    </p>
                    <p className="text-xs text-realestate-secondary mt-0.5 hidden lg:block">
                      {property.address}
                    </p>
                  </td>
                  ...
                  <td className="py-3">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${getPropertyStatusClasses(property.status)}`}
                    >
                      {property.status}
                    </span>
                  </td>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <Search
              size={16}
              className="absolute left-3 top-1/2 -translate-y-1/2 text-realestate-secondary"
            />
            <input
              type="text"
          ...
          <div className="relative">
            <Filter
              size={16}
              className="absolute left-3 top-1/2 -translate-y-1/2 text-realestate-secondary pointer-events-none"
            />
            <select
              value={roleFilter}
            ...
            >
              ...
              <option value={UserRole.PROPERTY_MANAGER}>
                Property Manager
              </option>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="px-6 py-3 text-sm font-semibold text-realestate-secondary font-inter hidden md:table-cell">
                  Email
                </th>
                <th className="px-6 py-3 text-sm font-semibold text-realestate-secondary font-inter">
                  Role
                </th>
                <th className="px-6 py-3 text-sm font-semibold text-realestate-secondary font-inter hidden sm:table-cell">
                  Status
                </th>
                <th className="px-6 py-3 text-sm font-semibold text-realestate-secondary font-inter hidden lg:table-cell">
                  Joined
                </th>
                <th className="px-6 py-3 text-sm font-semibold text-realestate-secondary font-inter">
                ...
                <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-sm text-realestate-primary">
                        {u.name}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${getRoleBadgeClasses(u.role)}`}
                    >
                      {u.role.replace("_", " ")}
                    </span>
                  </td>
                  <td className="px-6 py-4 hidden sm:table-cell">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${getStatusBadgeClasses(u.status)}`}
                    >
                      {u.status.replace("_", " ")}
                    </span>
                  </td>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              {MOCK_PROPERTIES.map((property) => (
                ...
                >
                  <td className="px-6 py-4">
                    <p className="font-medium text-sm text-realestate-primary">
                      {property.title}
                    </p>
                    <p className="text-xs text-realestate-secondary mt-0.5 hidden lg:block">
                      {property.address}
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-sm font-semibold text-realestate-primary">
                  87.3%
                </span>
              </div>
              <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className="h-full bg-realestate-accent rounded-full"
                  style={{ width: "87.3%" }}
                />
              </div>
            </div>
            <div>
              ...
              <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className="h-full bg-realestate-secondary rounded-full"
                  style={{ width: "8.2%" }}
                />
              </div>
            </div>
        ...
        <div className="card-elevated p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="text-sm font-medium text-realestate-primary">
                  New Registrations
                </p>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-xs text-realestate-secondary">
          ...
          <div className="space-y-4">
            <div>
              <label
                ...
                className="block text-sm font-medium text-realestate-secondary mb-1 font-inter"
              >
                Platform Name
              </label>
              <input
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-realestate-primary font-inter">
                  Maintenance Mode
                </p>
                <p className="text-xs text-realestate-secondary font-inter">
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                desc: "Notifications for new property listings",
                enabled: true,
              },
              {
                label: "Payment Alerts",
                desc: "Alerts for payment issues or failures",
                enabled: true,
              },
              {
                label: "System Alerts",
                desc: "Critical system performance notifications",
                enabled: false,
              },
            ].map((pref) => (
              <div
              ...
              >
                ...
                >
                  <span
                    className={`block w-5 h-5 bg-white rounded-full shadow-sm transition-transform ${pref.enabled ? "translate-x-[1.375rem]" : "translate-x-0.5"}`}
                  />
                </button>
              </div>
            ))}
